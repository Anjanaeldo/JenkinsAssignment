...
<title>Jenkins Assignement</title>
</head>
<body>
	<div class="container-fluid">
		<div class="panel panel-success">
			<div class="panel-heading" align="center">
				<h4>
					<b><font style="color: #1DA1F2" style="font-family: fantasy;"
						size="20px">Jenkins Automation Build</font> </b>
				</h4>
			</div>
							...
							<form action="print.do" method="post">
								<div class=”form-group”>
									<button type="submit" style="width: 100%; font-size: 1.1em;"
										...
										<b><font style="color: #1DA1F2">SHOW STATUS</font></b>
									</button>
